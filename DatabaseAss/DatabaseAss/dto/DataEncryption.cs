...
namespace DatabaseAss.dto
{
    ...
    {
        private string keyCode = "NTXTH";
        private string inputCode;
        private string outputCode;

        public DataEncryption(string inputCode, string outputCode)
        {
            InputCode = inputCode;
            OutputCode = outputCode;
            if (InputCode == null)
            {
                InputCode = DecryptString(OutputCode, keyCode);
            }
            else
                OutputCode = EncryptString(InputCode, keyCode);
        }

        public string InputCode { get => inputCode; set => inputCode = value; }
        public string OutputCode { get => outputCode; set => outputCode = value; }
